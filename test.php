...
try
{
   ...
   /*$sql = "INSERT INTO Schedule (firstName, lastName, religion, contactInfo, burial, music, specific_requests, gender)
    VALUES ('Aiden', 'Navarro', 'Church of Latterday Saints', '1800-trash', 'Yes', 'Currents the Entire Album', 'Do a back flip', 'Firefox')";
...
//first name, last name, religion (O), contact info (O), burial/cremation, music (O), specific requests (O), gender